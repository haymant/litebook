    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div class="d2-theme-header" :style="{ opacity: this.searchActive ? 0.5 : 1 }" flex-box="0" flex>
        <router-link
          ...
          flex-box="0">
          <img v-if="asideCollapse" :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/lb.svg`">
          <img v-else :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/lb.svg`">
        </router-link>
...
import d2Order from './components/header-order'
